...
use DebtCollectionBundle\Entity\Address;
...
class AddressController extends Controller
{
    ...
    public function newAction(Request $request,Client $client)
    {
        ...
        $form = $this->createForm('DebtCollectionBundle\Form\AddressType', $address);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $em->persist($address);
            $em->flush($address);
            return $this->redirectToRoute('client_edit', array('id' => $address->getClient()->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($address);
        $editForm = $this->createForm('DebtCollectionBundle\Form\AddressType', $address);
    ...
    public function deleteAction(Request $request, Address $address)
    {
        ...
        return $this->redirectToRoute('client_show',array('id' => $address->getClient()->getId()));
    }
